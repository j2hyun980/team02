$(function () {
  ...
  $(".findlogin .complete .fill").click(function () {
    location.href = 'https://dolbahyo.vercel.app/';
  });
  ...
  /* 생년월일모달 */
  $(".birth_form_bottom").hide();
  $(".member .birth_form_top .txt_box").click(function () {
    $(".modal_wrap.birth").show();
  });

  /* 생년월일모달닫기 */
  $(".member .birth .modal_btn_list .stroke").click(function () {
    $(".birth").hide();
  });

  /* 생년월일모달닫기고 생일추가 */
  $(".member .birth .modal_btn_list .fill").click(function () {
    $(".birth_form_top").hide();
    $(".birth_form_bottom").show();
    $(".birth").hide();
  });
  ...
  /* 알림 셀렉트박스*/
  $(".alarem_modi_container .sel_wrap li:not(:first-child)").hide();
  $(".alarem_modi_container .sel_wrap").click(function () {
    $(".alarem_modi_container .sel_wrap li:not(:first-child)").slideToggle();
    $(this).toggleClass("shadow");
  });
